    ...
    <div class="row">
        <div class="col-lg-5">
            <?php $form = ActiveForm::begin(['id' => 'form-signup']); ?>
                ...
                <?= $form->field($model, 'phone_office')->textInput()->label('Телефон раб.:',['class'=>'mb-1 fw-bold']); ?>
                <?= $form->field($model, 'phone_mobile')->textInput()->label('Телефон моб.:',['class'=>'mb-1 fw-bold']); ?>
